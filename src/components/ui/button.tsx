  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-smooth focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        tertiary:
          "bg-tertiary text-tertiary-foreground hover:bg-tertiary-hover shadow-soft",
        success:
        ...
        agriculture: 
          "bg-gradient-primary text-primary-foreground hover:shadow-agriculture hover:scale-105 transition-all duration-300",
        nature:
          "bg-gradient-nature text-white hover:shadow-strong hover:scale-105 transition-all duration-300",
        hero:
          "bg-gradient-hero text-white shadow-agriculture hover:shadow-strong hover:scale-105 transition-all duration-500 font-semibold",
      },
      size: {
