-- Inserir dados de exemplo para o sistema SEDAG
...
INSERT INTO public.produtores (nome, cpf, rg, data_nascimento, telefone, whatsapp, email, caf_numero, caf_validade, endereco, comunidade, aldeia, associacao_id, observacoes, status) VALUES
('José Silva dos Santos', '123.456.789-00', '1234567 SSP/RR', '1975-03-15', '(95) 99123-4567', '(95) 99123-4567', 'jose.santos@email.com', 'CAF001234567', '2024-12-31', 'Sítio Esperança, s/n', 'Vila Santa Rosa', NULL, (SELECT id FROM public.associacoes WHERE nome = 'Associação dos Produtores de Santa Rosa'), 'Produtor de milho e feijão', 'ativo'),
('Maria Conceição Lima', '234.567.890-11', '2345678 SSP/RR', '1980-07-22', '(95) 98234-5678', '(95) 98234-5678', 'maria.lima@email.com', 'CAF002345678', '2024-11-15', 'Fazenda Boa Vista, km 8', 'Alto Mucajaí', NULL, (SELECT id FROM public.associacoes WHERE nome = 'Cooperativa Agrícola do Alto Mucajaí'), 'Especializada em horticultura', 'ativo'),
('Pedro Henrique Costa', '345.678.901-22', '3456789 SSP/RR', '1970-12-08', '(95) 97345-6789', '(95) 97345-6789', NULL, 'CAF003456789', '2025-02-28', 'Lote 15, Projeto de Assentamento', 'São José', NULL, (SELECT id FROM public.associacoes WHERE nome = 'Associação São José dos Agricultores'), 'Criação de gado e agricultura familiar', 'ativo'),
('Ana Santos Oliveira', '456.789.012-33', '4567890 SSP/RR', '1985-09-12', '(95) 96456-7890', '(95) 96456-7890', 'ana.oliveira@email.com', 'CAF004567890', '2024-01-15', 'Sítio Palmeiras, Vicinal 12', 'Santa Rosa', NULL, (SELECT id FROM public.associacoes WHERE nome = 'Associação dos Produtores de Santa Rosa'), 'CAF vencido - necessário renovar', 'ativo'),
('Carlos Eduardo Souza', '567.890.123-44', '5678901 SSP/RR', '1978-05-03', '(95) 95567-8901', '(95) 95567-8901', NULL, 'CAF005678901', '2024-10-30', 'Fazenda Três Irmãos', 'Mucajaí', NULL, (SELECT id FROM public.associacoes WHERE nome = 'Cooperativa Agrícola do Alto Mucajaí'), 'CAF vencendo em breve', 'ativo');
